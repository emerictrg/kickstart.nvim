...
vim.keymap.set('n', '<leader>E', ':E<CR>', { desc = 'Show Netrw', silent = true })
...
vim.keymap.set('n', '<leader>gf', require('telescope.builtin').git_status, { desc = 'Search [G]it [S]tatus files' })
